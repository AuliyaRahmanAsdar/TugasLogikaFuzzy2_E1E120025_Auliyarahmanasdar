...
selected_columns = ["Selling_Price", "Present_Price"]  # Ganti dengan nama kolom yang sesuai pada file CSV
...
for i in range(c):
    plt.scatter(X[:, 0], X[:, 1], c=U[:, i], cmap='rainbow', s=50, edgecolors='k', label=f'Cluster {i+1}', alpha=0.7)
